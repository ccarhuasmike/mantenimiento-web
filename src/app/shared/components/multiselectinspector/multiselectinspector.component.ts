...
@Component({
  selector: 'app-multiselectinspector',
  templateUrl: './multiselectinspector.component.html',
})
export class MultiSelectInspectorComponent  implements  OnInit{
  ...
  clientSeleccionado: InspectorElement[] = [
  ...
  search(): void {
    this.dialogo.open(BusquedaInspectorComponent, {
      maxWidth: '50vw',
      maxHeight: 'auto',
      height: 'auto',
      width: '50%',
  ...
  remove(fruit: InspectorElement): void {
