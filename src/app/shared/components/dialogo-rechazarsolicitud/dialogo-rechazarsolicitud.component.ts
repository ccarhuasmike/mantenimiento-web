...
@Component({
  selector: 'app-dialogo-rechazarsolicitud',
  templateUrl: './dialogo-rechazarsolicitud.component.html',
  styleUrls: ['./dialogo-rechazarsolicitud.component.css']
})
export class DialogoRechazarSolicutdComponent implements OnInit {
  submitted = false;
  ...
  constructor(
    ...
    public dialogo: MatDialogRef<DialogoRechazarSolicutdComponent>,
  ...
  ngOnInit() {
    ...
    this.datosBasicosFormGroup = this._formBuilder.group({
      ...
      mychkConfirmacion: [false, Validators.requiredTrue]
    });
  }
