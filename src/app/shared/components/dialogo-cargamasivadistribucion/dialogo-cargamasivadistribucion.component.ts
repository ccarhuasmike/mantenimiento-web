...
@Component({
  selector: 'app-dialogo-cargamasivadistribucion',
  templateUrl: './dialogo-cargamasivadistribucion.component.html',
  styleUrls: ['./dialogo-cargamasivadistribucion.component.css']
})
export class DialogoCargaMasivaDistribucionComponent implements OnInit {
  submitted = false;
  ...
  constructor(
    ...
    public dialogo: MatDialogRef<DialogoCargaMasivaDistribucionComponent>,
