...
export class NavbarComponent implements OnInit {
    ...
    async ngOnInit() {
        ...
        //this.cookieService.set('listClientePorUsuario',JSON.stringify(this.listClientePorUsuario));
        this.objetoClientePorUsuario = this.listClientePorUsuario.find(x => { return x.Id == this.datosEdi.IdCliente });
        /* } else{
             this.listClientePorUsuario = JSON.parse( this.cookieService.get('listClientePorUsuario'));
             this.objetoClientePorUsuario=this.listClientePorUsuario.find(x=>{return x.Id==this.datosEdi.IdCliente});
         }*/
        ...
        //this.clienteSeleccionado.ClienteSeleccionado(this.objetoClientePorUsuario);   
        //}
