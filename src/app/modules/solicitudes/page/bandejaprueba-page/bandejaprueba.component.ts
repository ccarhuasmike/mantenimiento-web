...
@Component({
  selector: 'app-bandejaprueba',
  templateUrl: './bandejaprueba.component.html',
  styleUrls: ['./bandejaprueba.component.css','./table-basic-bandejaprueba.scss']
})
export class BandejaPruebaComponent implements OnInit {
