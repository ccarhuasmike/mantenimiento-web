...
@Component({
  selector: 'app-consultasolicitudes',
  templateUrl: './consultasolicitudes.component.html',
  styleUrls: ['./consultasolicitudes.component.css'],
  providers: [CookieService]
})
export class ConsultaSolicitudesComponent implements OnInit, OnDestroy {    
  listaEstado: any;
